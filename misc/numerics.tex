...
\end{align*}
where $\alpha := \f{w_1}{k_\theta^2 v_0}$ where $\ep = \f{E}{v_0 k_\theta}$ is the unit of \cite[Fig 1]{TarKruVis19} defined in the caption. %Hence we need to multiply our energies by $v_0 k_\theta \ll 1$ to obtain the true ones. 
